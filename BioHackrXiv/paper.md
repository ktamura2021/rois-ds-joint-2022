...
Next, we compared orthology detection in the three tools by focusing on the five plant genes. The results are shown in Tables 2–6. In each table, OMA and OrthoDB (ODB) show the results for green plants and land plants, separated by a comma (green plants, land plants). EP indicates Ensembl Plants. Additionally, "N/A" in the NCBI Gene ID and Gene symbol indicate that the locus tag was not found in NCBI Gene.

For the identified orthologs of AT2G07050 (CAS1) in soybean, GLYMA_01G001300 was identified in all conditions (Table 2). OMA and OrthoDB identified more orthologs in green plants than in land plants. GLYMA_07G001300 and GLYMA_08G225800 have been identified as beta-amyrin synthase [@takagi2011manipulation], while GLYMA_08G027000 and GLYMA_20G192700 have been identified as lupeol synthase [@PPR568134]. Cycloartenol synthase, beta-amyrin synthase, and lupeol synthase are classified as oxidosqualene cyclases. Therefore, it is suggested that OrthoDB in green plants grouped these different types of oxidosqualene cyclases into a single group.
...
All three tools identified all or most of the three CYP716A genes. Additionally, OMA and OrthoDB (land plants) identified CYP716D genes.
...
# Acknowledgements
We thank the organizers and participants of BH22.9 (domestic biohackathon in Japan) for giving us the chance to discuss on this issue.
